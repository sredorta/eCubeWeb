...
function buildAndValidatePhone(a, b) {
  var c = "invalid";
  try {
    var d = i18n.phonenumbers.PhoneNumberUtil.getInstance(), e = d.getRegionCodeForCountryCode(b), f = d.parseAndKeepRawInput(a, e);
    if (d.isValidNumber(f)) {
      var g = i18n.phonenumbers.PhoneNumberType;
      d.getNumberType(f) == g.MOBILE && (c = d.format(f, i18n.phonenumbers.PhoneNumberFormat.E164), c = c.replace("+", ""));
    }
  } catch (h) {
    console.log(h);
  }
